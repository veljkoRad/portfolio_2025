export const skills = [
    { value: 90, label: "HTML / CSS", description: "Expert at responsive layouts and animations." },
    { value: 75, label: "Javascript", description: "Solid understanding of ES6+, DOM, and logic." },
    { value: 70, label: "React", description: "Experienced with hooks, context, and UI components." },
    { value: 60, label: "Wordpress", description: "Custom themes, plugins, Elementor,  and site setup." },
];
...
export const aboutTabContent = [
    {
        ...
        title: 'experience', content: (
            <>
                <strong>Web Developer / Marketing Assistant</strong> - Fortrade <br />
                2023 - Current <br /><br />
                <strong>Cnc Programmer</strong> - Konelek, 4M, Beopumpe <br />
                2018-2022
            </>
        )
    },
