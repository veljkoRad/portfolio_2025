...
const About = () => {
    ...
    return (
        <Box component='section' sx={{ backgroundColor: (theme) => theme.palette.primary.main }}>
                ...
                <Stack
                    ...
                    <MotionStack
                        ...
                        <Typography sx={{ letterSpacing: '1px' }} color="text.secondary">
                            I’m a frontend developer who started in PPC marketing and spent three years building landing pages and newsletters (150+ and counting). I enjoy coding, learning, and solving problems, and I’ve also built several React projects. Self-taught, curious, and always working on getting better.
                        </Typography>
                        <Tabs textColor="text" value={value} onChange={handleChange}>
                            {aboutTabs.map((item) => (
                                <Tab sx={{ fontSize: '18px', textTransform: 'none', marginTop: '20px' }} label={item} key={item} />
                            ))}
                        </Tabs>
